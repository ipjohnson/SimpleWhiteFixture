...
namespace SimpleWhiteFixture.xUnit.Impl
{
    public class UITheoryDiscoverer : IXunitTestCaseDiscoverer
    {
        ...
        public const string ClassName = "SimpleWhiteFixture.xUnit.Impl.UITheoryDiscoverer";
        
        public const string AssemblyName = "SimpleWhiteFixture.xUnit";
        ...
        protected virtual IXunitTestCase CreateTestCaseForTheory(ITestFrameworkDiscoveryOptions discoveryOptions, ITestMethod testMethod, IAttributeInfo theoryAttribute)
            => new UITheoryTestCase(diagnosticMessageSink, discoveryOptions.MethodDisplayOrDefault(), testMethod, theoryAttribute);
